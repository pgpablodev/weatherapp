...
const FutureWeatherMobile = ({id, latitud, longitud}) => {
    ...
    switch(nombreDia){
                ...
                <div className="future-mobile-widget" style={{backgroundColor: "#21233a", borderColor: "#21233a"}}>
                    <div className="future-mobile-main-section">
                        <div className="future-mobile-big">
                            ...
                            <div className="future-mobile-weather">
                                {temp}ºC
                            </div>
                        </div>
                    ...
                    <div className="future-mobile-side-section">
                        <div className="f-mobile-max-temp">
                            <div><FontAwesomeIcon icon={faTemperatureHigh} color="#ff6022" /></div>
                            <div>{maxTemp}ºC</div>
                        </div>
                        <div className="f-mobile-min-temp">
        ...
        case "LUN":
            return(
                <div className="future-mobile-widget" style={{backgroundColor: "#3a2d21", borderColor: "#3a2d21"}}>
                    <div className="future-mobile-main-section">
                        <div className="future-mobile-big">
                            <div className="future-mobile-icon">
                                <img src={icono} alt={weather}></img>
        ...
        case "MAR":
            return(
                <div className="future-mobile-widget" style={{backgroundColor: "#3a2122", borderColor: "#3a2122"}}>
                    <div className="future-mobile-main-section">
                        <div className="future-mobile-big">
                            <div className="future-mobile-icon">
                                <img src={icono} alt={weather}></img>
        ...
        case "MIÉ":
            return(
                <div className="future-mobile-widget" style={{backgroundColor: "#3a2721", borderColor: "#3a2721"}}>
                    <div className="future-mobile-main-section">
                        <div className="future-mobile-big">
                            <div className="future-mobile-icon">
                                <img src={icono} alt={weather}></img>
        ...
        case "JUE":
            return(
                <div className="future-mobile-widget" style={{backgroundColor: "#3a3a21", borderColor: "#3a3a21"}}>
                    <div className="future-mobile-main-section">
                        <div className="future-mobile-big">
                            <div className="future-mobile-icon">
                                <img src={icono} alt={weather}></img>
        ...
        case "VIE":
            return(
                <div className="future-mobile-widget" style={{backgroundColor: "#39213a", borderColor: "#39213a"}}>
                    <div className="future-mobile-main-section">
                        <div className="future-mobile-big">
                            <div className="future-mobile-icon">
                                <img src={icono} alt={weather}></img>
        ...
        case "SÁB":
            return(
                <div className="future-mobile-widget" style={{backgroundColor: "#2d213a", borderColor: "#2d213a"}}>
                    <div className="future-mobile-main-section">
                        <div className="future-mobile-big">
                            <div className="future-mobile-icon">
                                <img src={icono} alt={weather}></img>
